...
class CustomTextStyle {
  ...
  static const TextStyle mediumSubtitleTextStyle = TextStyle(
    fontSize: 16.0,
    fontWeight: FontWeight.w500,
    fontFamily: 'Cairo',
    color: Colors.grey,
  ...
  static const TextStyle bodyTextStyleWhite = TextStyle(
    fontSize: 16.0,
    fontFamily: 'Cairo',
    color: Colors.white,
  );
  ...
  static const TextStyle bigTitleTextStyleRed = TextStyle(
    fontSize: 32.0,
    fontWeight: FontWeight.bold,
    fontFamily: 'Cairo',
    color: Colors.red,
  ...
  static const TextStyle bodyTextStyleRed = TextStyle(
    fontSize: 16.0,
    fontFamily: 'Cairo',
    color: Colors.white,
  );
